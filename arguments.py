...
def add_train_args(parser):
    ...
    group.add_argument('--n_epochs', type=int, default=100)
    group.add_argument('--iwae', type=int, default=1)
    group.add_argument('--train_batch_size', type=int, default=100)
    group.add_argument('--test_batch_size', type=int, default=10)
    group.add_argument('--lr', type=float, default=1e-3)
    group.add_argument('--device', type=str, default='cuda:0')
    group.add_argument('--eval_interval', type=int, default=1)
    ...
    group.add_argument('--test_samples', type=int, default=50)
    group.add_argument('--exp_name', type=str, default='UNTITLED')
